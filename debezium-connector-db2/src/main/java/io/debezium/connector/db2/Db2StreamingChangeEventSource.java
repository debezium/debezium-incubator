...
public class Db2StreamingChangeEventSource implements StreamingChangeEventSource {
    ...
    public Db2StreamingChangeEventSource(Db2ConnectorConfig connectorConfig, Db2OffsetContext offsetContext, Db2Connection dataConnection, Db2Connection metadataConnection, EventDispatcher<TableId> dispatcher, ErrorHandler errorHandler, Clock clock, Db2DatabaseSchema schema) {
