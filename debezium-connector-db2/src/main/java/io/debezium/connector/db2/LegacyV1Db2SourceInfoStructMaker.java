...
public class LegacyV1Db2SourceInfoStructMaker extends LegacyV1AbstractSourceInfoStructMaker<SourceInfo> {
    ...
    public LegacyV1Db2SourceInfoStructMaker(String connector, String version, CommonConnectorConfig connectorConfig) {
