 ...
 */
public class ChangeRecordEmitter extends BaseChangeRecordEmitter<ColumnValue> {

    private final RowLCR lcr;

    public ChangeRecordEmitter(OffsetContext offset, RowLCR lcr, Table table, Clock clock) {
